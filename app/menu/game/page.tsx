...
import { getGameMenu } from '../../lib/wordpress-api';
import Image from 'next/image';

export const metadata: Metadata = {
  title: 'Меню из дичи',
  description: 'Меню из дичи ресторана Meatra - для настоящих гурманов',
};

export const revalidate = 3600;

export default async function GameMenuPage() {
  const dishes = await getGameMenu();
      ...
      <div className="pt-[60px] sm:pt-[70px] lg:pt-[90px] w-full">
        ...
        <nav className="bg-meatra-gray border-t border-gray-800 py-4 px-4 mt-8">
          <div className="max-w-[1720px] mx-auto flex flex-wrap justify-center sm:justify-between items-center gap-4">
            ...
            <a href="/menu/game" className="text-meatra-gold text-[14px] sm:text-[16px] font-medium">
              Меню из дичи
            </a>
